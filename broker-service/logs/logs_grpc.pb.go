...
type LogServiceClient interface {
	...
	ListLogs(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error)
}
...
func (c *logServiceClient) ListLogs(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	out := new(ListResponse)
	err := c.cc.Invoke(ctx, "/logs.LogService/ListLogs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LogServiceServer interface {
	...
	ListLogs(context.Context, *ListRequest) (*ListResponse, error)
...
func (UnimplementedLogServiceServer) ListLogs(context.Context, *ListRequest) (*ListResponse, error) {
...
func _LogService_ListLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/logs.LogService/ListLogs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogServiceServer).ListLogs(ctx, req.(*ListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
